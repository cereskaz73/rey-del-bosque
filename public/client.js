...
socket.on('combat_prompt', (d)=>{
  ...
  showOverlay(`<h3>⚔️ ¡Te atacan!</h3><p>Una ficha enemiga ataca a tu ficha. ¿Qué haces?</p>
    ...
    ${canFlee?'':'<p style="font-size:.8rem">No te quedan otras fichas ocultas: debes aceptar.</p>'}`, false);
...
function showOverlay(html, autoMs){
...
function hideOverlay(){ $('overlay').classList.add('hidden'); ui.overlayLock=false; renderAll(); }
