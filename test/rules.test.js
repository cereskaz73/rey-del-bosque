...
// --- Rey atacando: el defensor decide primero ---
{
  const st = custom([
    ...
    { owner: 'red', type: 'lobo', cellId: '-1,1', id: 'rl' },
...
// --- Cepo atacando: se autoelimina sin revelar al defensor ---
{
  const st = custom([
    ...
    { owner: 'red', type: 'rey', cellId: '-1,1', id: 'rr' },
...
// --- Cepo atacante cuya baja aislaría una ficha del bloque total → empate por conectividad ---
{
  const st = custom([
    { owner: 'red', type: 'cepo', cellId: '0,-1', id: 'rc' },   // único enlace de r2 con la masa
    { owner: 'red', type: 'abeja', cellId: '0,-2', id: 'r2' },
  ...
  // Contraste de la regla global: si la ficha "colgante" toca a una ENEMIGA, el bloque no se parte y el cepo sí muere.
  const st2 = custom([
    { owner: 'red', type: 'cepo', cellId: '0,-1', id: 'rc' },
    { owner: 'red', type: 'abeja', cellId: '1,-1', id: 'r2' },  // toca a bl(0,0): conectada vía enemigo
    { owner: 'blue', type: 'lobo', cellId: '0,0', id: 'bl' },
    { owner: 'blue', type: 'rey', cellId: '0,1', id: 'br' },
  ]);
  const r2b = fight(st2, 'red', 'rc', 'bl');
  const ev2 = r2b.events.find((e) => e.type === 'combat_result');
  ok(ev2.result === 'attacker_self' && !st2.pieces.rc.alive, 'la conexión a través de fichas enemigas cuenta: el bloque global no se parte');
}
...
// --- Tablas ---
{
  ...
  const st3 = custom([
    ...
    { owner: 'red', type: 'rey', cellId: '-1,0', id: 'rr' },
    { owner: 'blue', type: 'lobo', cellId: '0,1', id: 'bl' },
    { owner: 'blue', type: 'rey', cellId: '1,0', id: 'br' },   // pegado al oso rojo: sigue conectado tras la baja
  ]);
